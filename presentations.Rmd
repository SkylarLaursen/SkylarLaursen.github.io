...
**Laursen, S.J.**, & Fiacconi, C.M. (submitted). Probing the effect of perceptual (dis)fluency: It’s all relative. Canadian Society for Brain Behaviour and Cognitive Science (CSBBCS), Jul. 2022, Halifax, NS.

**Laursen, S.J.**, & Fiacconi, C.M. (accepted). Does restudying entail a hidden cost for non-restudied information: A real-world application of the list strength effect. Toronto Area Memory Group (TAMeG), May 2022, Toronto, ON.
...
**Laursen, S.J**., & Fiacconi, C.M. (submitted). Assessing the effort invested when selecting items for restudy: Is there a role for cognitive offloading? Canadian Society for Brain Behaviour and Cognitive Science (CSBBCS), Jul. 2022, Halifax, NS.
